...
- **Local Package Mirror:** [`submission/calle-skill/`](OpenDoor-project-files/submission/calle-skill/)
...
- **Mandatory References:** [`references/safety.md`](OpenDoor-project-files/submission/calle-skill/references/safety.md) & [`references/examples.md`](OpenDoor-project-files/submission/calle-skill/references/examples.md)
